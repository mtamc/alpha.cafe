...
import Content exposing (Msg, Status, liLink, lineBreak, link, nestedLi, viewPageMain)
...
view _ =
    viewPageMain "Yokohama Kaidashi Kikou links and communities"
        [ section []
            [ ul []
                [ li [] [ strong [] [ text "Active communities" ] ]
                , ul []
                    [ li []
                        [ text "Discord "
            ...
            , ul []
                [ li [] [ strong [] [ text "Art and fan content" ] ]
                , ul []
            ...
            , ul []
                [ li []
                    [ strong [] [ text "Inactive communities" ]
                    , ul []
