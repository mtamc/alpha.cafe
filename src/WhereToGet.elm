...
import Content exposing (Status, link, md, nestedLi, viewImageThumb, viewPageMain, viewSection)
        ...
        , viewSection ( "merch_list", "List of YKK merchandise" )
            ...
            , ul []
                ...
                , li []
                    ...
                    , link "https://imgur.com/a/xpXfRAU" "the super rare items that I have never seen for sale"
                    , text ":"
                    , ul []
