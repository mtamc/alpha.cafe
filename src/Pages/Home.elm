...
page =
    ...
    , h1Text = "Everything about Yokohama Kaidashi akikou!"
    , view = view
    }
...
view viewerStatus =
    ...
    , whyReadYkk
        ...
        |> List.map (Hlp.callWithArg viewerStatus >> C.pageSection)


whatIsThisSite : V.Model -> C.PageSection V.Msg
whatIsThisSite viewerStatus =
    { title = "What's this site?"
    , htmlId = "what_is_this_site"
    , content =
        [ V.videoThumb viewerStatus "home" "illus1" ""
...
whatIsYkk : V.Model -> C.PageSection V.Msg
whatIsYkk viewerStatus =
    { title = "What's Yokohama Kaidashi Kikou?"
    , htmlId = "what_is_ykk"
    , content =
        [ V.videoThumb viewerStatus "home" "illus2" ""
        ...
        , V.videoThumb viewerStatus "home" "illus3" "pull_me_up"
...
whatIsYkkAbout : V.Model -> C.PageSection V.Msg
whatIsYkkAbout viewerStatus =
    { title = "What's YKK about?"
    , htmlId = "what_is_ykk_about"
    , content =
        [ V.videoThumbOnlyOneSize viewerStatus "home" "illus4" ""
        ...
        , V.videoThumb viewerStatus "home" "illus5" "pull_me_up"
...
whyReadYkk : V.Model -> C.PageSection V.Msg
whyReadYkk viewerStatus =
    { title = "Why should I read/watch YKK?"
    , htmlId = "why_read_ykk"
    , content =
        [ V.videoThumb viewerStatus "home" "illus6" "right"
        ...
        , V.imgThumb viewerStatus "home" "ykkpage" "jpg" "Page from YKK" "large left"
        ...
        , C.blockquote "Hitoshi Ashinano" "Contemporary anime is in constant movement. Despite that, Director Annou carefully internalized the impression of spaces, pauses, and elements like that. So I believe I am lucky to have him as director."
        ...
        , V.imgThumb viewerStatus "home" "colorpage" "png" "Page from YKK" "large right pull_me_up"
